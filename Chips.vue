...
.content:hover {
  background-color: rgba(35, 54, 45, 0.08);
}
.wrapper:focus {
  outline: none;
  background: rgba(35, 54, 45, 0.12);
  border: 1px solid #00A153!important;
  border-radius: 8px;
}
.icon1 {
  display: flex;
...
.active {
  background: rgba(35, 54, 45, 0.12)!important;
  border: 1px solid #00A153!important;
  border-radius: 8px;
}
</style>
